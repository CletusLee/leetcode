...
public class TestAddTwoNumbers {
	...
	@Test
	public void testAddTwoNumbersWithDifferentLength() {
		ListNode l1 = new ListNode(2,4,3);
		ListNode l2 = new ListNode(5,6,4,5);
		...
		assertThat(result.next.val, is(0));
		assertThat(result.next.next.val, is(8));
		assertThat(result.next.next.next.val, is(5));
	...
	public void abc() {
		...
		assertThat(result.next.next.next, is(nullValue()));
	}
}
